...
import 'package:dell_project/onboarding/bloc/onboarding_bloc.dart';
...
class OnboardingContent extends StatelessWidget {
  ...
  children:   [
    ...
    BlocBuilder<OnboardingBloc, OnboardingState>(
        buildWhen: (dynamic_, dynamic currState) => currState is PageChangedState,
        builder: (dynamic context, dynamic state) {
    ...
    Spacer(),
    BlocBuilder<OnboardingBloc, OnboardingState>(
      buildWhen: (dynamic_,currState)=> currState is PageChangedState,
